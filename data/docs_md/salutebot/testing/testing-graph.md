...
source_url: "https://github.com/baslie/salutebot-docs/blob/main/data/docs_md/salutebot/testing/testing-graph.md"
...
[![](/assets/salutebot/testing/testing-graph/salutebot-new.png)
SaluteBot](../overview.md)[![](/assets/salutebot/testing/testing-graph/Graph.png)
...
2. Нажмите кнопку
   ![запустить](/assets/salutebot/testing/testing-graph/base64_3_5e882219.png)
   или используйте сочетание клавиш ALT+W.

Code соберет чат-бот и запустит его в тестовом виджете:

![тестовый виджет](/assets/salutebot/testing/testing-graph/test-widget-d0345b86229b9625bc544320f976027d.png)
