...
source_url: "https://github.com/baslie/salutebot-docs/blob/main/data/docs_md/salutebot/bot-development/tegs-tests/test-widget.md"
...
[![](/assets/salutebot/bot-development/tegs-tests/test-widget/salutebot-new.png)
SaluteBot](../../overview.md)[![](/assets/salutebot/bot-development/tegs-tests/test-widget/Code.png)
...
2. Нажмите кнопку
   ![запустить](/assets/salutebot/bot-development/tegs-tests/test-widget/base64_3_5e882219.png)
   или используйте сочетание клавиш ALT+W.

Code соберет чат-бот и запустит его в тестовом виджете:

![тестовый виджет](/assets/salutebot/bot-development/tegs-tests/test-widget/test-widget-d0345b86229b9625bc544320f976027d.png)
