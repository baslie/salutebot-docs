---
title: "Логи сервера"
source_url: "https://github.com/baslie/salutebot-docs/blob/main/data/docs_md/salutebot/bot-development/project-structure/server-logs.md"
...
[![](/assets/salutebot/bot-development/project-structure/server-logs/salutebot-new.png)
SaluteBot](../../overview.md)[![](/assets/salutebot/bot-development/project-structure/server-logs/Code.png)
...
![Логи сервера в редакторе сценариев](/assets/salutebot/bot-development/project-structure/server-logs/server-logs-2d13e0fe79bf7865ac2dd8c2a0c2ff47.png)
...
![Очищать префиксы](/assets/salutebot/bot-development/project-structure/server-logs/base64_4_5347b7d6.png)
.

Чтобы полностью очистить окно вывода логов, нажмите кнопку

![Очистить](/assets/salutebot/bot-development/project-structure/server-logs/base64_5_a0faca0d.png)
.
