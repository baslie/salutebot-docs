...
[![](/assets/bot-steps/scenario-creation/scenario-creation-guide/salutebot-new.png)
SaluteBot](../../overview.md)[![](/assets/bot-steps/scenario-creation/scenario-creation-guide/Graph.png)
Graph](https://developers.sber.ru/docs/ru/va/graph/overview)[![](/assets/bot-steps/scenario-creation/scenario-creation-guide/Code.png)
